...
Sample ParseSampleFields(const std::vector<std::string>& fields) {
  ...
  sample.depth_m = ValidateNumericField(fields[1], "depth_m");
  sample.api_gravity = ValidateNumericField(fields[2], "api_gravity");
  sample.sulfur_pct = ValidateNumericField(fields[3], "sulfur_pct");
  sample.density_g_cm3 = ValidateNumericField(fields[4], "density_g_cm3");
